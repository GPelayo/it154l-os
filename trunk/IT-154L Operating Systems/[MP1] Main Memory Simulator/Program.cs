...
namespace MainMemorySimulator
{
    public class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            currentMemory = new FixedPartitionMemory(partitions,jobQueue, false, ScehdulerType.FJFO);
        ...
        static void Display()
        {
            ...
            foreach(Partition partition in currentMemory.MemoryBlocks)
            {
                ...
                Console.Out.WriteLine(currentJob.Name + ": \t(" + currentJob.MemorySpace + "KB) \tT-" + partition.CurrentJob.TimeLeft);
            }
